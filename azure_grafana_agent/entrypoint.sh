...
replaceGrafanaAgentConfigValue "AZURE_CLIENT_SECRET" "<replace_azure_client_secret>" 1 0
replaceGrafanaAgentConfigValue "AZURE_TENANT_ID" "<replace_azure_tenant_id>" 1 0
